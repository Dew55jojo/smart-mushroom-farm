...
#define BOT_TOKEN "7597767933:AAElUeXlBwRj8cFY1UAYGEG0J0FPiPhPWno"   // <-- แทนด้วย token ของคุณ
#define CHAT_ID   "7700755118"     // <-- แทนด้วย chat id ของคุณ
